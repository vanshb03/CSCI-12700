...
def getData():
     ...
     df = pd.read_csv(file) #<-- placeholder, can remove once defined.
...
def getColumnNames():
     ...
     latName, lonName = input("Lat: "), input("Long: ") #<-- placeholder, can remove once defined.
...
def getLocale():
     ...
     lat, lon = float(input("Lat: ")), float(input("Long: "))      #<-- placeholder, can remove once defined.
